...
public class SituationE {
    ...
    private Graph graph = new SingleGraph("Situation_E");

    private final Queue<String> usedKeys = new ArrayDeque<>();
    ...
    public void CompareArraysForSectionE() {
    ...
    public void action(){
        ...
        situationE.compareTwoArraysToGetNodeC(Randomizer(10,17),Randomizer(7,28));
     
    }

    private void compareTwoArraysToGetNodeC(int randomizer, int randomizer1) {
    }
